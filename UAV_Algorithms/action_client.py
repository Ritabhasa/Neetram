...
from waypoint_navigation.action import NavToWaypoint  # Assuming the action is defined in this package
...
class WayPointClient(Node):
    ...
    def send_goal(self, waypoint):
        ...
        goal_msg = NavToWaypoint.Goal()  # Creating the goal message
